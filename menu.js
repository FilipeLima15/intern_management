...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const links = {
        ...
        cronograma: toFolder + 'Cronograma.HTML',
        acompanhamento: toFolder + 'disciplinas.html',
        jurisprudencia: toFolder + 'jurisprudencia.html',
        charts: toFolder + 'charts.html', // Caminho correto para o gráfico
    ...
    const isActive = (key) => {
        if (key === 'home' && (currentPath.endsWith('index.html') || currentPath.endsWith('/') || (currentPath.endsWith('disciplinas.html') && !inSubfolder))) return true;
        if (key === 'cronograma' && currentPath.includes('Cronograma')) return true;
        if (key === 'acompanhamento' && currentPath.includes('disciplinas.html') && inSubfolder) return true;
